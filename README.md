# espnet - asrtts
###### forked from espnet
###### librispeech recipe for ASR-TTS training to improve ASR performance

# Auxiliary task (text-to-speech) is trained using this method and the results are as below

#### text | has never been surpassed |
Model | AudioFile |
Baseline | <audio src="samples/base_1.wav" controls preload></audio> |
ASR<->TTS | <audio src="samples/our_1.wav" controls preload></audio> |
GroundTruth | <audio src="samples/GT_1.wav" controls preload></audio> |
