...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument('--train-unpaired-json', type=str, default=None,
                        help='Filename of train label data (json)')
    parser.add_argument('--valid-json', type=str, default=None,
                        help='Filename of validation label data (json)')
    parser.add_argument('--speech-only', default=False, action='store_true',
                        help='Unpaired speech only')
    parser.add_argument('--text-only', default=False, action='store_true',
                        help='Unpaired text only')
    parser.add_argument('--oracle-length', default=False, action='store_true',
                        help='Oracle length while prediction')
    ...
    parser.add_argument('--lr-decay', default=0.01, type=float,
    ...
    parser.add_argument('--tts-init', default=None, type=str,
                        help='Pretrained TTS model for intialization')
    parser.add_argument('--alpha', default=0.95, type=float,
                        help='Multitask learning coefficient, alpha: alpha*unsupervised + (1-alpha)*supervised ')
    parser.add_argument('--tts', type=strtobool,
                        default=False,
                        help='include TTS. ')
    parser.add_argument('--update-tts', type=strtobool,
                        default=False,
                        help='update TTS. ')
    parser.add_argument('--sampling', type=str, default='categorical',
                        help='types of sampling the asr text')
