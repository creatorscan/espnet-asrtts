...
class SelfAttEncoder(torch.nn.Module):
...
def encoder_for(args, idim):
    return SelfAttEncoder(idim=idim, num_blocks=args.elayers,
            attention_dim=args.eprojs, linear_units=args.eunits, dropout_rate=args.dropout_rate)
