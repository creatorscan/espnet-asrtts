...
from espnet.nets.pytorch_backend.rnn.decoders_selfatt import decoder_for
#from espnet.nets.pytorch_backend.rnn.encoders import encoder_for
from espnet.nets.pytorch_backend.rnn.encoders_selfatt import encoder_for
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def __init__(self, idim, odim, args):
        ...
        self.denc = encoder_for(args, idim)
        # ctc
    ...
    def forward(self, xs_pad, ilens, ys_pad, asrtts=False):
        """E2E forward
        ...
        hs_pad, hlens = self.enc(hs_pad, hlens, src_mask)
        ...
        if asrtts:
            ...
            self.loss_att, best_hyps = self.dec.generate_forward(hs_pad, torch.tensor(hlens), ys_pad, self.recog_args)
            #else:
        ...
        if asrtts:
            self.reporter.report(loss_ctc_data, float(self.loss_att.mean()), acc, cer_ctc, cer, wer, float(self.loss_att.mean()))
    ...
    def calculate_all_attentions(self, xs_pad, ilens, ys_pad):
        ...
        with torch.no_grad():
            ...
            if self.replace_sos:
                ...
                tgt_lang_ids = None
            hpad, hlens = self.enc(hs_pad, hlens, None)
